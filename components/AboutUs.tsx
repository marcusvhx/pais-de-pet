  ...
  return (
    ...
    >
      <div className=" text-base/5 md:text-lg/6 w-full sm:place-self-center ">
        ...
        <p className="">
          A País de Pet é um centro de cuidados completos para animais de
          estimação, criado com um propósito claro: promover saúde, bem-estar e
          qualidade de vida para os pets e tranquilidade para os seus tutores.
          <br />
          <br />
          Nascemos da paixão pelos animais e da vontade de oferecer um
