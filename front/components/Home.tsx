...
export default async function Home({}: {}) {
  ...
  return (
    <section
      id="home"
      className="relative w-full h-dvw 3xs:h-[90dvh] text-center text-sm xs:text-base 3xs:text-lg bg-cover bg-top bg-[url(/images/backgrounds/home-bg.png)]"
    >
      ...
      <div className="w-full absolute bottom-15 left-1/2 -translate-x-1/2 z-2 flex justify-center flex-wrap gap-2 text-nowrap capitalize text-base md:text-lg ">
        <a
